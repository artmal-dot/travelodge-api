...
import com.example.travelodgeapi.TravelodgeApiApplication;

public class BrowserUserAgent {
	public static  String userAgents = "Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Ubuntu Chromium/37.0.2062.94 Chrome/37.0.2062.94 Safari/537.36\n"
	...
	public static String generateRandomAgentName() {
		String[] userAgentsList = userAgents.split(System.lineSeparator());
		Random r = new Random();
		int low = 0;
		int high = userAgentsList.length;
